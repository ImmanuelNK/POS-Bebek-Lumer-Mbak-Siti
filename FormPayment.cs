...
namespace ALP_SAD_DBI
{
    public partial class FormPayment : Form
    {
        ...
        private void FormPayment_Load(object sender, EventArgs e)
        {
            ...
            Payment.Image = Image.FromFile(@"F:\SAD - AFL 3 PROJECT\T_PAYMENTBSR.png");
        ...
        private void BtnPaymentClick(object sender, EventArgs e)
        {
            ...
            payment.Image = Image.FromFile(@"F:\SAD - AFL 3 PROJECT\T_PAYMENTSELECT.png");
            checkorder.Image = Image.FromFile(@"F:\SAD - AFL 3 PROJECT\T_CHECKORDER.png");
        ...
        private void BtnCheckOrder(object sender, EventArgs e)
        {
            ...
            payment.Image = Image.FromFile(@"F:\SAD - AFL 3 PROJECT\T_PAYMENT.png");
            checkorder.Image = Image.FromFile(@"F:\SAD - AFL 3 PROJECT\T_CHECKORDERSELECTED.png");

            PictureBox CheckOrderTXT = new PictureBox();
            CheckOrderTXT.Size = new Size(372, 38);
            CheckOrderTXT.Location = new Point(73, 70);
            CheckOrderTXT.Image = Image.FromFile(@"F:\SAD - AFL 3 PROJECT\T_CHECK ORDER.png");
